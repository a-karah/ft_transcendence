...
let GameGateway = class GameGateway {
    constructor() {
        ...
        this.game = (match_id, match_info_id) => {
    ...
    win_loss_function(info) {
        ...
        const createdData = db.matchHistory.create({
            data: {
        ...
        const loser = db.user.findUnique({
            where: {
    ...
    handleNewConnectionFunction(client, data) {
        if (data[0] == "connected") {
            for (let i = 0; i < client_array.length; i++)
    ...
    alreadyInGameHandleFunction(client, invited_id) {
    ...
    handleJoinRoomFromAnotherPage(client, user_id) {
...
], GameGateway.prototype, "handleNewConnectionFunction", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('already_in_game'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, Number]),
    __metadata("design:returntype", void 0)
], GameGateway.prototype, "alreadyInGameHandleFunction", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('user_move'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, String]),
    __metadata("design:returntype", void 0)
], GameGateway.prototype, "userMouseMovementHandle", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('out-room'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, Object]),
    __metadata("design:returntype", void 0)
], GameGateway.prototype, "outRoomRequestHandler", null);
__decorate([
...
__decorate([
    (0, websockets_1.SubscribeMessage)('join-room_from_another_page'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, Number]),
    __metadata("design:returntype", void 0)
], GameGateway.prototype, "handleJoinRoomFromAnotherPage", null);
